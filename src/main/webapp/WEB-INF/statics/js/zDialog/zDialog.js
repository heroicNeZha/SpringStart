var URL = 'js/zDialog/images/';	//附件上传路径，包含：图片、视频、音频、附件等文件
// var IMAGESPATH = URL;
...
Dialog.prototype.create = function () {
    ...
    var html = '\
  <table id="_DialogTable_{thisID}" cellspacing="0" cellpadding="0" border="0" style="font-size:12px;border-radius:4px; line-height:1.4;border-collapse: collapse; background-color: #fff; width: ' + (this.Width + 26) + 'px;">'
  if(this.borderFlag) {
      ...
      <td width="8" height="23" style="background-color:#f3f6f9;border-radius:4px 0 0 0;"><div style="width: 8px;"></div></td>\
      <td height="42" style="background-color:#f3f6f9; align:center;">\
	  <div style="float: left; color:#666; width: 95%; text-align:center; font-size: 18px; font-family: 微软雅黑"><span id="_Title_{thisID}">' + this.Title + '</span></div>\
        <div id="_ButtonClose_{thisID}" onclick="Dialog.getInstance(\'{thisID}\').cancelButton.onclick.apply(Dialog.getInstance(\'{thisID}\').cancelButton,[]);" style="margin: 4px 0 0;*margin-top: 5px; position: relative;top:auto; cursor: pointer; float: right; height: 16px; width: 16px; background: url({IMAGESPATH}icon.png) 0 0; background-position: 0 -40px;' + (ielt7 ? "margin-top: 3px;" : "") + (this.ShowCloseButton ? "" : "display:none;") + '"></div>\
        <div style="width:5px; height: 12px; float: right; "></div><div id="_ButtonWinSize_{thisID}" onclick="Dialog.changeWinSizeFun()" style="margin: 4px 0 0;*margin-top: 5px; position: relative;top:auto; cursor: pointer; float: right; height: 16px; width: 16px; background: url({IMAGESPATH}icon.png) 0 0; background-position:-32px -40px;' + (ielt7 ? "margin-top: 3px;" : "") + (this.ChangeWinSize ? "" : "display:none;") + '"></div></td>\
      <td width="8" height="23" style="background-color:#f3f6f9;border-radius:4px;"><div style="width: 8px;"><a id="_forTab_{thisID}" href="#;"></a></div></td>\
    </tr>';
  	} else {
  		html+=  '<tr id="_Draghandle_{thisID}">\
  		<td width="8" height="23"><div style="width: 8px;"></div></td>\
        <td height="33"></td>\
        <td width="8" height="23"><div style="width: 8px;"><a id="_forTab_{thisID}" href="#;"></a></div></td>\
  		</tr>';
  	}
   
    html+= '<tr valign="top">';
    if(this.borderFlag) {
    	html += '<td style="background-color: #f3f6f9;border-radius:4px;"></td>'
    } else {
    ...
    html += '<td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          <tr id="_MessageRow_{thisID}" style="' + (this.ShowMessageRow ? "" : "display:none") + '">\
            <td valign="top" height="50"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f3f6f9" id="_MessageTable_{thisID}">\
                <tr>\
          ...
          <tr>\
            <td valign="top" align="center"><div id="_Container_{thisID}" style="position: relative; background: #fff; width: 100%;border:1px solid #ccc;">\
	...
	' + (function (obj) {
        ...
        return "";
          ...
          <td style="hieght: 56px;"><div id="_DialogButtons_{thisID}" style="width:100%; height:8px; text-align: right;position:absolute;bottom:54px;">\
        ...
        if(this.borderFlag) {
        	html += '<td style="background-color: #f3f6f9;"></td>'
        } else {
        	html += '<td style="border-left: 1px solid #6cabe2"></td>'
        }
    html += '</tr><tr>'
    	if(this.borderFlag) {
	    html += '<td height="8" style="background-color: #f3f6f9;border-radius:4px;"></td>\
	      <td style="background-color: #f3f6f9;border-radius:4px;"></td>\
	      <td height="8" style="background-color: #f3f6f9;border-radius:4px;"><a onfocus=\'$id("_forTab_{thisID}").focus();\' href="#;"></a></td>'
    	} else {
    		html += '<td height="9"></td>\
...
Dialog.changeWinSizeFun = function() {
	...
	if(diag.ChangeWinSize) {
		if(changeWinSizeFlag) {
			var win = window;
			var doc = win.document;
			var cw = doc.compatMode == "BackCompat" ? doc.body.clientWidth : doc.documentElement.clientWidth;
			var ch = doc.compatMode == "BackCompat" ? doc.body.clientHeight : doc.documentElement.clientHeight;
			changeWinSizeFlag = false;
			diag.OldWidth = diag.Width;
			diag.OldHeight = diag.Height;
			diag.setSize(cw-14, ch-70);
