...
public class ProductImageController {
    ...
    public String add(ProductImage pi, HttpSession session, UploadedImageFile uploadedImageFile) {
        ...
        if (ProductImageService.type_single.equals(pi.getType())) {
            imageFolder = session.getServletContext().getRealPath("statics/img/productSingle");
            imageFolder_small = session.getServletContext().getRealPath("statics/img/productSingle_small");
            imageFolder_middle = session.getServletContext().getRealPath("statics/img/productSingle_middle");
        } else {
            imageFolder = session.getServletContext().getRealPath("statics/img/productDetail");
        }
